...
<table width="250" height="150" border="0" cellpadding="0" cellspacing="0" >
  <tr>
    <td height="101" colspan="2" scope="row"><a href="MuestraEvento.php?id=<?php echo $op['CodigoEvento'];?>"><img src=<?php echo $op['Imagen'];?> width="57" height="65" border="0" style="padding:2px; margin-left:15px;"/></a></td>
